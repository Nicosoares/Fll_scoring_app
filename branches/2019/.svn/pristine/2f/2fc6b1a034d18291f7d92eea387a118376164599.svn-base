...
public class CreateUser extends BaseFLLServlet {
  ...
  protected void processRequest(final HttpServletRequest request,
	...
	PreparedStatement addUserName = null;
    ResultSet rs = null;
    ...
    try {
	  ...
	  addUserName = connection.prepareStatement("INSERT INTO fll_user_data (fll_user, fll_user_name) VALUES(?, ?)");
	  addUserName.setString(1, user);
	  addUserName.setString(2, user_name);
	  addUserName.executeUpdate();
	  ...
	  SQLFunctions.close(addUserName);
